...
.backgroundLogin {
    ...
    background: url(../../public/saiyanBackground.jpeg) no-repeat center center;
    /* background: url(../../public/lamaArcobaleno.jpg) no-repeat center center; */
